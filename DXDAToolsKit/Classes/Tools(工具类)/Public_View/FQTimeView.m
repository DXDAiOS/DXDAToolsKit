...
-(void)setBtnType
{
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.timeBtn attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeLeft multiplier:1 constant:0]];
