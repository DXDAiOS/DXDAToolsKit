...
@interface DXDASelectPhotoManager()<UIImagePickerControllerDelegate, UINavigationControllerDelegate>

//@property (nonatomic, assign) NSInteger currentIndex;           // 当前下标
//@property (nonatomic, assign) NSInteger currentPhotoCount;      // 当前图片数组个数
//是否新增图片
@property (nonatomic, assign) BOOL isNewPic;
@property (nonatomic, assign) NSInteger re_index;
@end
...
//        [self showAlertWithTitle:nil message:message];
         ...
         UIImagePickerControllerSourceTypeCamera])
    {
        ...
        [[UIResponder returnController] presentViewController:picker animated:YES completion:nil];
    }
}
...
- (void)showAlertWithTitle:(NSString *)title message:(NSString *)message
{
    ...
    [[UIResponder returnController] presentViewController:alert animated:YES completion:nil];
}
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *,id> *)info
{
    ...
    if (self.isNewPic) {
        ...
        self.photoArray[_re_index] = image;
        [self reUploadAction:_re_index];
    }
}
